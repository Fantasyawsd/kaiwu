...
# ObsData: feature=528D vector, legal_action=16D mask / 特征向量与合法动作掩码
...
def _calc_gae(list_sample_data):
    ...
    for sample in reversed(list_sample_data):
        ...
        delta = -sample.value + sample.reward + gamma * sample.next_value * done_mask
        gae = gae * gamma * lamda * done_mask + delta
