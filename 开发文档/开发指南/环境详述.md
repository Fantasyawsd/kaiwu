...
在开始开发前，请仔细阅读[腾讯开悟强化学习开发框架](https://tencentarena.com/docs/p-competition-gorge_chase/15.0.1/guidebook/taa-rl-fw/intro/)，深入理解环境、智能体、工作流等核心概念及其相关接口的使用方法。
...
> 2. 若需调整模型评估任务时的配置，用户需要通过腾讯开悟平台创建评估任务并完成环境配置，详细参数见[智能体模型评估模式](https://tencentarena.com/docs/p-competition-gorge_chase/15.0.1/guidebook/dev-guide/agent/#模型评估模式)。
...
下面会对这些数据进行介绍，完整的观测数据结构可以参考[数据协议](https://tencentarena.com/docs/p-competition-gorge_chase/15.0.1/guidebook/dev-guide/protocol/).
