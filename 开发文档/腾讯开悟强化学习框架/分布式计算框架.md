...
![1_整体架构_图](https://tencentarena.com/docs/p-competition-gorge_chase/15.0.1/assets/images/framework-1193d54abbc44155659ab3b5820e4c55.png)
...
训练工作流的核心函数，在workflow中可自定义训练流程。可以在[智能体/工作流开发](https://tencentarena.com/docs/p-competition-gorge_chase/15.0.1/guidebook/taa-rl-fw/rl_agent/workflow/)中查看详细的训练工作流代码示例。
