...
以下为实现强化学习算法的核心函数介绍，有关函数的更多细节可以查阅[分布式计算框架](https://tencentarena.com/docs/p-competition-gorge_chase/15.0.1/guidebook/taa-rl-fw/distributed_computing_fw/#agent)
